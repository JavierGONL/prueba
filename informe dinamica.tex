...
La evolución temporal de $y_c$ muestra la carrera útil del martillo y la relación temporal entre la fase de descenso y la fase de retorno rápido.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{{salidas/yc_vs_t}.png}
    \caption{Posición vertical del martillo $y_c$ durante un ciclo.}
    \label{fig:yc_ciclo}
\end{figure}
