...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{{salidas/yc_vs_t}.png}
    \caption{Posición vertical $y_c(t)$ del martillo: se aprecia carrera y asimetría del ciclo.}
    \label{fig:yc_ciclo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{{salidas/ac_vs_t}.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{{salidas/tau_vs_t}.png}
...
\begin{itemize}
    ...
    \item La variación del par $\tau$ respecto al tiempo nos permite visualizar la ida y vuelta en el martillo (esto gracias a la simetria que se puede notar en la grafica). Esto nos demuestra que para mantener un cierto valor deseado en la aceleracion centroidal del martillo c es necesario a lo largo del funcionamiento del mecanismo aplicar un par variable.
\end{itemize}
